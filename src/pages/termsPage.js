  ...
  return (
    <Center>
      <Box
        ...
        paddingBottom="10vh"
      >
        <Heading as="h2" mb="5vh">
          Terms of Service of <span class="website_url">Turradgiver.com</span>
        </Heading>

        <Text textAlign="justify">
          <span class="website_name">Turradgiver</span> ("Us" or "We") provides
          the <span class="website_url">Turradgiver.com</span> website and
        ...
        <Text textAlign="justify">
          ...
          <span class="date"> 2021</span>. We expressly reserve the right to
        ...
        <Text textAlign="justify" mb="5vh">
          ...
          under copyright of <span class="website_name">Turradgiver</span> or
          ...
          <span class="website_name">Turradgiver</span> or its Affiliates.
        </Text>
        ...
        <Text textAlign="justify">
          ...
          <span class="website_name">Turradgiver</span> spokesperson speaking in
        ...
        <Text textAlign="justify">
          ...
          the internal laws of the <span class="country">fr</span> without
        ...
        <Text textAlign="justify" mb="5vh">
          ...
          in the federal courts of <span class="country">fr</span>.
        </Text>
      </Box>
    </Center>
  );
