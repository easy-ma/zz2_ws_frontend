...
const ad2 = {
  imgSrc:
    "https://news.airbnb.com/wp-content/uploads/sites/4/2019/10/Romania-A-Airbnb-20-for-2020-2.jpg",
...
const ad3 = {
  imgSrc:
    "https://a0.muscache.com/im/pictures/3853d9c2-daf1-45f9-84f8-c73f60deea99.jpg",
  title: "Right on the top of NY",
  description:
    " Must-visit shops, eateries & sights are right on your doorstep.Smart design & refined style flow throughout this contemporary atmosphere.",
...
const ad4 = {
  imgSrc:
    "https://a0.muscache.com/im/pictures/miso/Hosting-46500242/original/bf661f58-6e1e-42fb-b9dd-b92f7a7b1b6d.jpeg",
  title: "Right on the top of NY",
  description:
    " Must-visit shops, eateries & sights are right on your doorstep.Smart design & refined style flow throughout this contemporary atmosphere.",
  adress: "5 Madison Avenue",
...
const Ads = (props) => {
  ...
  return (
    ...
    <Slider
      zoom={props.zoom}
      dispatch={dispatch}
      leftButton={pages[`page${pageNumber - 1}`] !== undefined}
      rightButton={pages[`page${pageNumber + 1}`] !== undefined}
      ads={pages[`page${pageNumber}`]}
    />
  );
};
